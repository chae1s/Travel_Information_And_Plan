  ...
  <main>
    <div class="content">
      ...
      <div class="item_popular_section">
        ...
        <ul class="item_list_default" v-if="!clickChecked">
          <li>
            <router-link :to="'/item-detail/read/' + 5464">
              <v-img src="@/assets/images/daegu_image1.jpg" alt="" height="155px" width="277.5" class="rounded-lg" cover/>
              <div class="item_text">
                <div class="item_title">가창 찐빵 골목</div>
              </div>
            </router-link>
            <ul class="item_count">
              <li @click="toggleBookmark(5464)">관심등록</li>
            </ul>
          </li>
          <li>
            <router-link :to="'/item-detail/read/' + 5465">
              <v-img src="@/assets/images/daegu_image2.jpg" alt="" height="155px" width="277.5" class="rounded-lg" cover/>
              <div class="item_text">
                <div class="item_title">감삼못공원</div>
              </div>
            </router-link>
            <ul class="item_count">
              <li @click="toggleBookmark(5465)">관심등록</li>
            </ul>
          </li>
          <li>
            <router-link :to="'/item-detail/read/' + 5466">
              <v-img src="@/assets/images/daegu_image3.jpg" alt="" height="155px" width="277.5" class="rounded-lg" cover/>
              <div class="item_text">
                <div class="item_title">강정고령보</div>
              </div>
            </router-link>
            <ul class="item_count">
              <li @click="toggleBookmark(5466)">관심등록</li>
            </ul>
          </li>
          <li>
            <router-link :to="'/item-detail/read/' + 5467">
              <v-img src="@/assets/images/daegu_image4.jpg" alt="" height="155px" width="277.5" class="rounded-lg" cover/>
              <div class="item_text">
                <div class="item_title">경극고택</div>
              </div>
            </router-link>
            <ul class="item_count">
              <li @click="toggleBookmark(5467)">관심등록</li>
            </ul>
          </li>
        </ul>
        <ul class="item_list" v-if="clickChecked">
...
export default {
  ...
  methods: {
    ...
    fetchItems(checked) {
      ...
      console.log("f itemSido"+this.itemSido);
      console.log("p itemSide"+this.itemSido);
...
.item_list_default .item {
  width: 25%;
  padding: 0 10px;
  box-sizing: border-box;
}

.item_list_default .item img {
  width: 100%;
  height: 155px;
  border-radius: 8px;
}

.item_list_default .item_info {
  margin-top: 10px;
}
/**/
